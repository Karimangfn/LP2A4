...
<meta charset="UTF-8">
<title>Lista de Pessoas Norte</title>
</head>
<body>
	<div class="Header">
		...
		<div class="container-size">
			<div class="left-box">
				...
				<div class="filters">
					...
					<div class="inputs">
						<input class="radio" type="radio" name="filter" id="norte" checked></input> <label
			...
			<div class="right-box">
				...
				<c:forEach var="listpicture" items="${listpicture}" varStatus="status">
					<c:if test="${listlocation[status.index].region == 'norte'}">
					<div class="card">
