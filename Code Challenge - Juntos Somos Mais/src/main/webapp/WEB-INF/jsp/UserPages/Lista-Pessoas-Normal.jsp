...
<meta charset="UTF-8">
<title>Lista de Pessoas Normal</title>
</head>
<body>
	<div class="Header">
		...
		<div class="container-size">
			<div class="left-box">
				<div class="filters">
					...
					<div class="inputs">
						<input class="radio" type="radio" name="filter" id="Normal" checked></input> <label
			...
			<div class="right-box">
				...
				<c:forEach var="listpicture" items="${listpicture}" varStatus="status">
					...
					<c:if test="${listcoordinates[status.index].longitude <= '20.411580'}">
					<c:if test="${listcoordinates[status.index].latitude >= '-26.361899'}">
