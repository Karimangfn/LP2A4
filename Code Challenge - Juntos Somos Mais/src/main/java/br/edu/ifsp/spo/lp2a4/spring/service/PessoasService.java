...
import br.edu.ifsp.spo.lp2a4.spring.repository.CoordinatesRepository;
...
public class PessoasService {
	...
	@Autowired 
	private CoordinatesRepository repository5;
	...
	//Coordinates
	public List<Coordinates> listAllc() {

		List<Coordinates> coordinates = new ArrayList<>();
		repository5.findAll().forEach(coordinates::add);		
		return coordinates;
	}

	public void addResult(Coordinates coordinates) {
		repository5.save(coordinates);
	}
