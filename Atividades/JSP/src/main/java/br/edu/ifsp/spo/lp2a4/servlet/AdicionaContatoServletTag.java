...
@WebServlet("/adicionaContatoTag")
public class AdicionaContatoServletTag extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
        ...
        out.println("<br/>");
        out.println("<a href=\"http://localhost:8080/LP2-Maven-JSP/Adiciona-contatos.jsp\"><button>Voltar</button></a>");
        out.println("</body>");
        out.println("</html>");
	}
}